const products = {
  Earphones: [
    ...
    },
    {
      ...
      description: "click more details☝️.",
      price: "₹849",
      longDescription: "Touch operation, type-c charging, 700mAh battery, Ceramic finish, Next-Gen PixArt Chipset",
      extraImages: [
    ...
    },
    {
      ...
      description: "click more details☝️",
      price: "₹799",
      longDescription: "Premium airpods pro2 with battery backup, sensor, engraving, compatible with all devices.",
      extraImages: [
  ...
  Headsets: [
    ...
    },
    {
      ...
      description: "click more details☝️.",
      price: "₹829",
      longDescription: "TF card support, Aux cable, 360 audio, wireless",
      extraImages: [
